							...
							<?php $form = ActiveForm::begin(['id' => 'organization_document_form']); ?>
								...
								<div class="row" style="margin-top:20px">
											<div class="col-md-12 form-area">
												...
												<div class="box-label">MEMORANDUM </div>
													...
													<div class="row">
														...
														<div class="col-md-12">
															<?= $form->field($model, 'document_type')->hiddenInput(['value' => 'memorandum'])->label(false); ?>
...
<?
	$processMemorandum = Url::to(['applicants/processorganizationdocumentformmemorandum']);
