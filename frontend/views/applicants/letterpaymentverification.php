...
<?
	$verifypaymentData = Url::to(['applicants/proccesspaymentveriletter','id' => $model[0]->file_number_id]);
	
	$loadpaymentveri = Url::to(['applicants/letterpaymentverification']);
        ...
        success: function (data) {
			...
			if(data.status == 1 || data.status == 2){
				...
				// triger leters
					...
					$(document).find('#renderapplicationform').load('$loadpaymentveri'+'&id='+newData[0].file_number_id);
