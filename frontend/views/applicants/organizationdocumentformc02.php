							...
							<?php $form = ActiveForm::begin(['id' => 'organization_document_form']); ?>
								...
								<div class="row" style="margin-top:20px">
											<div class="col-md-12 form-area">
												...
												<div class="box-label">CAC C02 FORM </div>
													...
													<div class="row">
														...
														<div class="col-md-12">
															...
															<div class="form-group">
																	<?= $form->field($model, 'document_type')->hiddenInput(['value' => 'cac c02'])->label(false); ?>
...
<?
	$processC02Url = Url::to(['applicants/processorganizationdocumentformc02']);
	$loadC07Form = Url::to(['applicants/organizationdocumentformc07']);
	$biodataform = <<<JS
  ...
  $(document).find("#customFile").addClass("selected").html('fileName');
    ...
    $.ajax({
        ...
        success: function (data) {
        	newData = data.data
			if(data.status == 1){
				$(document).find('#renderapplicationform').load('$loadC07Form'+'&id='+data.data.applicant_id);
