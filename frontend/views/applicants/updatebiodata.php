                    ...
                    'labelOptions' => [ 'class' => 'custom-file-label' ]])->fileInput(['class'=>'customFile']) ?>
								...
								<div class="row">
                                    ...
                                    <div class="col-md-4">
											 ...
											 'options' => ['id'=>'lga'],
											'data'=>[$model->local_government_of_origin => getCity($model->local_government_of_origin)],
											 'pluginOptions'=>[
												 'depends'=>['state'],
												 'placeholder' => 'Select...',
...
<?
	$updateBioUrl = Url::to(['applicants/processbiodataupdate','id' =>$model->id,'updateid' => $updateid]);
	$biodataform = <<<JS
