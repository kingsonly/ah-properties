...
<!--							form content goes here-->
							<?php $form = ActiveForm::begin(['id' => 'paymentDetails']); ?>
								...
								<div class="row" style="margin-top:20px">
											<div class="col-md-12 form-area">
												...
												<div class="box-label">Payment FOR FILE  <?= $model->filenumber->file_number?> </div>
												
												<?= $form->field($model, 'applicant_id')->hiddenInput(['value' => $model->applicant_id])->label(false); ?>
																
																<?= $form->field($model, 'file_number_id')->hiddenInput(['value' => $model->file_number_id])->label(false); ?>
												<div class="row">
														<div class="col-md-4">
                    ...
                    'labelOptions' => [ 'class' => 'custom-file-label' ]])->fileInput(['class'=>'customFile'])?>
												...
												<div class="row">
														<div class="col-md-6">
															<div class="form-group">
																<?= $form->field($model, 'amount_word')->textInput(); ?>
														    </div>
														</div>
														<div class="col-md-6">
															<div class="form-group">
...
<?
	$createpaymenttUrl = Url::to(['applicants/processpaymentupdate','id' =>$model->id,'updateid' => $updateid]);
