...
--
-- Table structure for table `kdm_agents`
--

CREATE TABLE `kdm_agents` (
  `id` int(255) NOT NULL,
...
--
-- Table structure for table `kdm_country`
--

CREATE TABLE `kdm_country` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `kdm_country`
--

INSERT INTO `kdm_country` (`id`, `sortname`, `name`, `phonecode`) VALUES
(1, 'AF', 'Afghanistan', 93),
(2, 'AL', 'Albania', 355),
(3, 'DZ', 'Algeria', 213),
...
--
-- Table structure for table `kdm_payment`
--

CREATE TABLE `kdm_payment` (
  `id` int(255) NOT NULL,
  `applicant_id` varchar(25) NOT NULL,
  `payment_id` varchar(50) NOT NULL,
  `bill_reff` varchar(50) NOT NULL,
  `payment_mode` varchar(50) NOT NULL,
  `image` varchar(200) NOT NULL,
  `bank_branch` varchar(100) NOT NULL,
  `payment_date` date NOT NULL,
  `receipt_date` date NOT NULL,
  `teller_number` varchar(50) NOT NULL,
  `amount` int(100) NOT NULL,
  `amount_word` varchar(100) NOT NULL,
  `payment_for` varchar(100) NOT NULL,
  `receit_id` varchar(50) NOT NULL,
  `status` int(2) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Table structure for table `kdm_state`
--

CREATE TABLE `kdm_state` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `kdm_state`
--

INSERT INTO `kdm_state` (`id`, `name`, `country_id`) VALUES
...
('m000000_000000_base', 1595107153),
('m130524_201442_init', 1595107156),
('m190124_110200_add_verification_token_column_to_user_table', 1595107156);
...
INSERT INTO `user` (`id`, `username`, `auth_key`, `password_hash`, `password_reset_token`, `email`, `status`, `created_at`, `updated_at`, `verification_token`, `first_name`, `last_name`) VALUES
(1, 'admin', '9Vew3JswASRvSHaGd7wPDG2R572sgmPh', '$2y$13$haspFfpaegvoHw61aaNzBuff0n2QbWb/VzP5fN3s7pbNnVEMKN3b2', NULL, 'admin@gmail.com', 10, 1595148186, 1595148186, '9x-EUmZBqS7nv2DNerhDMYK16wJVyHdM_1595148186', 'Achumie', 'kingsley'),
(2, 'admin2', '6rEn23aNyEmAGSP1VlZXJkwMw-4-qhxf', '$2y$13$foklALIdCHTqdzT9teneXOdZmvD3R5Y7rj5TTaSwWD1nFWnsO2jZ.', NULL, 'admin2@gmail.com', 10, 1595148260, 1595148260, 'I4gVULRV8Irlk8az1wAzLQ1UdYPGsYTx_1595148260', 'Achumie', 'Joy');
...
--
-- Indexes for table `kdm_agents`
--
ALTER TABLE `kdm_agents`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `kdm_country`
--
ALTER TABLE `kdm_country`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `kdm_payment`
--
ALTER TABLE `kdm_payment`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `kdm_state`
--
ALTER TABLE `kdm_state`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT for table `kdm_agents`
--
ALTER TABLE `kdm_agents`
...
--
-- AUTO_INCREMENT for table `kdm_country`
--
ALTER TABLE `kdm_country`
...
--
-- AUTO_INCREMENT for table `kdm_payment`
--
ALTER TABLE `kdm_payment`
  MODIFY `id` int(255) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `kdm_state`
--
ALTER TABLE `kdm_state`
...
--
-- Constraints for table `kdm_state`
--
ALTER TABLE `kdm_state`
  ADD CONSTRAINT `Country` FOREIGN KEY (`country_id`) REFERENCES `kdm_country` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
COMMIT;
